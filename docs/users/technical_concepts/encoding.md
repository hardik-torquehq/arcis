...
Learn about the encoding formats used on Arcis. {synopsis}
...
previous versions, specially for client encoding and signing with Ledger devices. Arcis does not
...
allows for quick reconstruction of encoded data. Arcis uses RLP to encode/decode Ethereum
