...
Arcis is an EVM-compatible chain that supports Ethereum Web3 tooling. For this reason, gas
...
+++ https://github.com/Ambiplatforms-TORQUE/ethermint/blob/098da6d0cc0e0c4cefbddf632df1057383973e4a/x/evm/keeper/state_transition.go#L188
...
For this same reason, in Arcis it is possible to send transactions with `0` fees for transaction
...
(i.e `ValidateBasic`) function as well as on the custom `AnteHandler` defined by Arcis.
...
+++ https://github.com/Ambiplatforms-TORQUE/ethermint/blob/098da6d0cc0e0c4cefbddf632df1057383973e4a/x/evm/keeper/grpc_query.go#L100
