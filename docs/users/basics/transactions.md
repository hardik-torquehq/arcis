...
Learn more about transactions on Arcis {synopsis}
...
<!-- 
TODO: explain what transactions are on Arcis and blockchains. 
...
<!-- TODO: explain which transactions types does Arcis support (i.e modules and changes) and provide a few examples. -->
