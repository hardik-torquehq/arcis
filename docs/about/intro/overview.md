...
Learn about Arcis and its primary features. {synopsis}
...
Arcis allows for running vanilla Ethereum as a [Cosmos](https://cosmos.network/)
...
Here’s a glance at some of the key features of Arcis:
...
Arcis enables these key features by:
...
| Property                     | Value                                                |
|------------------------------|------------------------------------------------------|
| Arcis Testnet                | `{{ $themeConfig.project.testnet_chain_id }}`        |
| Arcis Mainnet                | `{{ $themeConfig.project.chain_id }}`                |
| Blockchain Explorer(s)       | [arcis.dev/tools/explorers](./../../developers/explorers.md) |
