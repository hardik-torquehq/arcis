...
Learn about Arcis with the list of official resources. {synopsis}
...
- Documentation (this site): [https://arcis.dev/](https://arcis.dev/)
- Open Source Codebase: [https://github.com/Ambiplatforms-TORQUE/arcis](https://github.com/Ambiplatforms-TORQUE/arcis)
- Website: [https://arcis.org/](https://arcis.org/)
- Blog: [https://arcis.blog/](https://arcis.blog/)
- Ethermint: [https://github.com/Ambiplatforms-TORQUE/ethermint](https://github.com/Ambiplatforms-TORQUE/ethermint)
...
Learn how to run an Arcis [node](./../../validators/quickstart/run_node.md) {hide}
