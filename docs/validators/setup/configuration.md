...
In `~/.arcisd/config/config.toml` you can set your peers.

See the [Add persistent peers section](https://arcis.dev/testnet/join.html#add-persistent-peers) in our docs for an automated method, but field should look something like a comma separated string of peers (do not copy this, just an example):
