...
The deposit period lasts either 5 days or until the proposal deposit totals 64 ARCIS, whichever happens first.

### Deposits

Deposit amounts are at risk of being burned. Prior to a governance proposal entering the voting period (ie. for the proposal to be voted upon), there must be at least a minimum number of ARCIS deposited (64). Anyone may contribute to this deposit. Deposits of passed and failed proposals are returned to the contributors.

In the past, different people have considered contributions amounts differently. There is some consensus that this should be a personal choice. There is also some consensus that this can be an opportunity for supporters to signal their support by adding to the deposit amount, so a proposer may choose to leave contribution room (ie. a deposit below 64 ARCIS) so that others may participate. It is important to remember that any contributed ARCIS are at risk of being burned.

### Burned deposits

Deposits are burned when proposals:

1. **Expire** - deposits will be burned if the deposit period ends before reaching the minimum deposit (64 ARCIS)
2. **Fail to reach quorum** - deposits will be burned for proposals that do not reach quorum ie. 40% of all staked ARCIS must vote
...
1. A minimum deposit of 64 ARCIS is required for the proposal to enter the voting period
...
Voting power is determined by stake weight at the end of the 14-day voting period and is proportional to the number of total ARCIS participating in the vote. Only bonded ARCIS count towards the voting power for a governance proposal. Liquid ARCIS will not count toward a vote or quorum.
