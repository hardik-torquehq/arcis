...
If you want to open a PR on the Cosmos SDK to update the documentation, please follow the guidelines in the [`CONTRIBUTING.md`](https://github.com/Ambiplatforms-TORQUE/arcis/tree/main/CONTRIBUTING.md#updating-documentation)
...
The documentation for Arcis is hosted at [arcis.dev](https://arcis.dev/)

built from the files in this (`/docs`) directory for
[master](https://github.com/Ambiplatforms-TORQUE/arcis/tree/main/docs).
