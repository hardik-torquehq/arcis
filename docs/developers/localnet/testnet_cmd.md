...
preparing test network with chain-id "arcis_1276974-1"
...
```bash
arcisd keys add test --recover
```

Check the balance of the account address:

```bash
arcisd q bank balances [address]
```
