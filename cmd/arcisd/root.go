...
import (
	...
	ethermintclient "github.com/Ambiplatforms-TORQUE/ethermint/client"
	"github.com/Ambiplatforms-TORQUE/ethermint/client/debug"
	"github.com/Ambiplatforms-TORQUE/ethermint/encoding"
	ethermintserver "github.com/Ambiplatforms-TORQUE/ethermint/server"
	servercfg "github.com/Ambiplatforms-TORQUE/ethermint/server/config"
...
// NewRootCmd creates a new root command for arcisd. It is called once in the
// main function.
func NewRootCmd() (*cobra.Command, params.EncodingConfig) {
	...
	initClientCtx := client.Context{}.
		...
		WithKeyringOptions(arciskr.Option()).
		WithViper(EnvPrefix)
...
func (a appCreator) appExport(
	...
	if height != -1 {
		arcisApp = app.NewArcis(logger, db, traceStore, false, map[int64]bool{}, "", uint(1), a.encCfg, appOpts)

		if err := arcisApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	} else {
		arcisApp = app.NewArcis(logger, db, traceStore, true, map[int64]bool{}, "", uint(1), a.encCfg, appOpts)
	}

	return arcisApp.ExportAppStateAndValidators(forZeroHeight, jailAllowedAddrs)
}
