...
// IsTestnet returns true if the chain-id has the Arcis testnet EIP155 chain prefix.
...
// GetArcisAddressFromBech32 returns the sdk.Account address of given address,
// while also changing bech32 human readable prefix (HRP) to the value set on
// the global sdk.Config (eg: `arcis`).
