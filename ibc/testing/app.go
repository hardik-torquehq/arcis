...
import (
	...
	arcisapp "github.com/Ambiplatforms-TORQUE/arcis/v5/app"
	ethermint "github.com/Ambiplatforms-TORQUE/ethermint/types"
)

var DefaultTestingAppInit func() (ibcgotesting.TestingApp, map[string]json.RawMessage) = arcisapp.SetupTestingApp
...
func SetupWithGenesisValSet(t *testing.T, valSet *tmtypes.ValidatorSet, genAccs []authtypes.GenesisAccount, chainID string, balances ...banktypes.Balance) ibcgotesting.TestingApp {
	...
	app.InitChain(
		abci.RequestInitChain{
			...
			ConsensusParams: arcisapp.DefaultConsensusParams,
