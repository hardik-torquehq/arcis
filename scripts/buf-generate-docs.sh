...
# also make sure that you are added to the Arcis organization on buf
...
buf mod update $ARCISPROTO

# then, push the arcis proto module and documentation 
buf push $ARCISPROTO

# two commit addresses should be printed to the command line
# the arcis documentation will have links to the third party documentation
