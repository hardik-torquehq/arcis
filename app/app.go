...
import (
	...
	ethermintapp "github.com/Ambiplatforms-TORQUE/ethermint/app"
	"github.com/Ambiplatforms-TORQUE/ethermint/encoding"
	srvflags "github.com/Ambiplatforms-TORQUE/ethermint/server/flags"
	ethermint "github.com/Ambiplatforms-TORQUE/ethermint/types"
	"github.com/Ambiplatforms-TORQUE/ethermint/x/evm"
	evmrest "github.com/Ambiplatforms-TORQUE/ethermint/x/evm/client/rest"
	evmkeeper "github.com/Ambiplatforms-TORQUE/ethermint/x/evm/keeper"
	evmtypes "github.com/Ambiplatforms-TORQUE/ethermint/x/evm/types"
	"github.com/Ambiplatforms-TORQUE/ethermint/x/feemarket"
	feemarketkeeper "github.com/Ambiplatforms-TORQUE/ethermint/x/feemarket/keeper"
...
func init() {
	...
	DefaultNodeHome = filepath.Join(userHomeDir, ".arcisd")

	// manually update the power reduction by replacing micro (u) -> atto (a) arcis
...
var (
	_ servertypes.Application = (*Arcis)(nil)
	_ simapp.App              = (*Arcis)(nil)
	_ ibctesting.TestingApp   = (*Arcis)(nil)
)

// Arcis implements an extended ABCI application. It is an application
...
// NewArcis returns a reference to a new initialized Ethermint application.
func NewArcis(
	logger log.Logger,
	db dbm.DB,
...
func (app *Arcis) Name() string { return app.BaseApp.Name() }
...
func (app *Arcis) BeginBlocker(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
...
func (app *Arcis) EndBlocker(ctx sdk.Context, req abci.RequestEndBlock) abci.ResponseEndBlock {
	return app.mm.EndBlock(ctx, req)
}

// We are intentionally decomposing the DeliverTx method so as to calculate the transactions per second.
func (app *Arcis) DeliverTx(req abci.RequestDeliverTx) (res abci.ResponseDeliverTx) {
	defer func() {
...
func (app *Arcis) InitChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
...
func (app *Arcis) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// ModuleAccountAddrs returns all the app's module account addresses.
func (app *Arcis) ModuleAccountAddrs() map[string]bool {
...
func (app *Arcis) BlockedAddrs() map[string]bool {
...
// LegacyAmino returns Arcis's amino codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *Arcis) LegacyAmino() *codec.LegacyAmino {
	return app.cdc
}

// AppCodec returns Arcis's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *Arcis) AppCodec() codec.Codec {
	return app.appCodec
}

// InterfaceRegistry returns Arcis's InterfaceRegistry
func (app *Arcis) InterfaceRegistry() types.InterfaceRegistry {
...
func (app *Arcis) GetKey(storeKey string) *sdk.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *Arcis) GetTKey(storeKey string) *sdk.TransientStoreKey {
...
func (app *Arcis) GetMemKey(storeKey string) *sdk.MemoryStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *Arcis) GetSubspace(moduleName string) paramstypes.Subspace {
	subspace, _ := app.ParamsKeeper.GetSubspace(moduleName)
	return subspace
}

// SimulationManager implements the SimulationApp interface
func (app *Arcis) SimulationManager() *module.SimulationManager {
	return app.sm
}

// RegisterAPIRoutes registers all application module routes with the provided
// API server.
func (app *Arcis) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *Arcis) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

func (app *Arcis) RegisterTendermintService(clientCtx client.Context) {
...
func (app *Arcis) GetBaseApp() *baseapp.BaseApp {
	return app.BaseApp
}

// GetStakingKeeper implements the TestingApp interface.
func (app *Arcis) GetStakingKeeper() stakingkeeper.Keeper {
	return app.StakingKeeper
}

// GetIBCKeeper implements the TestingApp interface.
func (app *Arcis) GetIBCKeeper() *ibckeeper.Keeper {
	return app.IBCKeeper
}

// GetScopedIBCKeeper implements the TestingApp interface.
func (app *Arcis) GetScopedIBCKeeper() capabilitykeeper.ScopedKeeper {
	return app.ScopedIBCKeeper
}

// GetTxConfig implements the TestingApp interface.
func (app *Arcis) GetTxConfig() client.TxConfig {
...
func (app *Arcis) setupUpgradeHandlers() {
	// v2 upgrade handler
