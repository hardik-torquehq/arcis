...
The `EVMChannels` parameter describes the list of Arcis channels that connected to EVM compatible chains and can be used during the ibc callback action.
