...
func init() {
	proto.RegisterEnum("arcis.claims.migration.v1.Action", Action_name, Action_value)
	proto.RegisterType((*Claim)(nil), "arcis.claims.migration.v1.Claim")
	proto.RegisterType((*ClaimsRecordAddress)(nil), "arcis.claims.migration.v1.ClaimsRecordAddress")
	proto.RegisterType((*ClaimsRecord)(nil), "arcis.claims.migration.v1.ClaimsRecord")
}

func init() { proto.RegisterFile("arcis/claims/v1/claims.proto", fileDescriptor_a7153f2307523893) }
