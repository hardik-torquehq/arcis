...
func TestParamsValidate(t *testing.T) {
	testCases := []struct {
		...
		{
			"success - constructor",
			NewParams(true, "tarcis", time.Unix(0, 0), DefaultDurationOfDecay, DefaultDurationUntilDecay, DefaultAuthorizedChannels, DefaultEVMChannels),
			false,
		},
	}
