...
2. An `epoch` begins and `rewards` ($ARCIS and other denoms) that are minted on every block for inflation are added to the inflation pool every block.
