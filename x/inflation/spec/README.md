...
The `x/inflation` module mints new Arcis tokens and allocates them in daily
epochs according to the [Arcis Token
Model](https://arcis.blog/the-arcis-token-model-edc07014978b) distribution to
...
The allocation of new coins incentivizes specific behaviour in the Arcis
